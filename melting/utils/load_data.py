...
class MeltingDataset(PTDataset):
    """
    MeltingDataset stores data generated according to Darcy's Law.
...
def load_melting_dataset(n_train,
    n_tests,
    batch_size,
    test_batch_sizes,
